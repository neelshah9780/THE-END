...
function setup() {
  ...
  fall = createSprite(290,240,1,1);
  over = createSprite(290,260,1,1);
  invisibalGround = createSprite(350,450,900,10);
  invisibalGround.shapeColor="lightGreen"
  
  restart = createSprite(380,390,20,20);
  ...
  ground = createSprite(350,450,900,10);
  ground.velocityX = 4;
...
function draw() {
  ...
  if(ground.x < 150){
   ...
   stroke("red");
   fill("red");  
   text("Press above icon to restart",270,465);  
 }
...
function createBananas(){
  if (frameCount% 80 === 0){
    var banana = createSprite(400,500,20,20);
...
function spawnObstacles(){
  if (frameCount% 300===0){
    obstacle = createSprite(400,420,50,50);
